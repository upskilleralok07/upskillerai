...
export const genAIModules: Module[] = [
  ...
  },
  {
    ...
    submodules: [
      ...
      { id: '7.5', title: 'RAG (Retrieval Augmented Generation)', duration: '2 min', videoUrl: 'https://www.youtube.com/watch?v=bIHNnSpn1Uc&start=1771' },
      { id: '7.6', title: 'AI Agents vs Chains', duration: '5 min', videoUrl: 'https://www.youtube.com/watch?v=bIHNnSpn1Uc&start=1888' },
      { id: '7.7', title: 'Building your first AI agent from scratch', duration: '60 min' },
      { id: '7.8', title: 'CLI-based coding agents with Claude', duration: '45 min' },
      { id: '7.9', title: 'RAG pipeline basics: indexing, retrieval, answering', duration: '55 min' },
      { id: '7.10', title: 'LangChain document loaders and text splitters', duration: '40 min' },
      { id: '7.11', title: 'Retrievers and vector stores in LangChain', duration: '50 min' },
      { id: '7.12', title: 'Advanced RAG with Redis/Valkey queues (async)', duration: '60 min' },
      { id: '7.13', title: 'Scaling RAG with workers + FastAPI', duration: '55 min' },
    ]
  },
  {
    id: 'module-8',
