...
export const genAIModules: Module[] = [
  ...
  },
  {
    ...
    submodules: [
      { id: '4.1', title: 'What are LLMs and how GPT works', duration: '45 min' },
      { id: '4.2', title: 'Tokenization and embeddings', duration: '40 min' },
      { id: '4.3', title: 'Attention and transformers', duration: '50 min' },
      { id: '4.4', title: 'Multi-head attention and positional encodings', duration: '45 min' },
      { id: '4.5', title: '"Attention is All You Need" intuition', duration: '35 min' },
    ]
  },
  {
    id: 'module-5',
